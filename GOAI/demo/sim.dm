...
/mob/goai/sim/CreateBrain(var/list/custom_actionslist = null)
...
/mob/goai/sim/proc/HandleAction(var/action, var/datum/ActionTracker/tracker)
	...
	while (tracker && running)
		...
		spawn(0)
			...
			var/mob/goai/sim/proc/actionproc = ((action in action_lookup) ? action_lookup[action] : null)
