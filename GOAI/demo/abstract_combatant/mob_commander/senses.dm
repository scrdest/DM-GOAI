...
/sense/combatant_commander_eyes/proc/UpdatePerceptions(var/datum/goai/mob_commander/owner)
...
/sense/combatant_commander_eyes/proc/SpotThreats(var/datum/goai/mob_commander/owner)
	if(isnull(owner))
		return
...
/sense/combatant_commander_eyes/proc/SpotWaypoint(var/datum/goai/mob_commander/owner)
	if(isnull(owner))
		return
...
/sense/combatant_commander_obstruction_handler/proc/SpotObstacles(var/datum/goai/mob_commander/owner)
	if(!owner)
		// No mob - no point.
		return
...
/sense/combatant_commander_panic_pathfinder/proc/SpotObstacles(var/datum/goai/mob_commander/owner)
	if(!(owner))
		// No mob - no point.
		return
...
/sense/combatant_commander_safespace_finder/proc/UpdateSafespace(var/datum/goai/mob_commander/owner)
	if(!owner)
		// useless in a vacuum
		return
...
/datum/goai/mob_commander/InitSenses()
	/* Parent stuff */
	. = ..()
