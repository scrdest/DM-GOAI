...
/datum/goai/sim_commander/proc/FightTick()
	if(!(src.pawn))
...
/datum/goai/sim_commander/proc/GetAimTime(var/atom/target)
	if(isnull(target))
		return
...
/datum/goai/sim_commander/proc/GetTarget(var/list/searchspace = null, var/maxtries = 5)
...
/datum/goai/sim_commander/proc/Shoot(var/obj/gun/cached_gun = null, var/atom/cached_target = null, var/datum/aim/cached_aim = null)
	. = FALSE
...
/datum/goai/sim_commander/proc/GetActiveThreatDicts() // -> list(/dict)
...
/datum/goai/sim_commander/proc/GetThreatDistances(var/atom/relative_to = null, var/list/curr_threats = null, var/default = 0, var/check_max = null) // -> num
	var/atom/rel_source = isnull(relative_to) ? src.pawn : relative_to
...
/datum/goai/sim_commander/proc/GetThreatAngles(var/atom/relative_to = null, var/list/curr_threats = null, var/check_max = null)
	var/atom/rel_source = isnull(relative_to) ? src.pawn : relative_to
