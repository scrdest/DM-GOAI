/datum/goai/sim_commander/proc/ChooseCoverleapLandmark(var/atom/startpos, var/atom/primary_threat = null, var/turf/prev_loc_memdata = null, var/list/threats = null, var/min_safe_dist = null, var/trust_first = null)
	if(!(src.pawn))
...
/datum/goai/sim_commander/proc/HandleDirectionalChooseCoverleapLandmark(var/datum/ActionTracker/tracker)
...
/datum/goai/sim_commander/proc/HandleDirectionalCoverLeapfrog(var/datum/ActionTracker/tracker)
	if(!(src.pawn))
		world.log << "[src] does not have an owned mob!"
		return
