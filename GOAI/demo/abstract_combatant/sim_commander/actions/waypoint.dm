...
/datum/goai/sim_commander/proc/SpotObstacles(var/datum/goai/sim_commander/owner, var/atom/target = null, var/default_to_waypoint = TRUE, var/proc/adjproc = null, var/proc/costproc = null)
	if(!owner)
		// No mob - no point.
		return
...
/datum/goai/sim_commander/proc/HandleWaypoint(var/datum/ActionTracker/tracker)
	// Locate waypoint
