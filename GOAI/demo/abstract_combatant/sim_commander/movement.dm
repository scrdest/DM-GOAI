...
/datum/goai/sim_commander/proc/CurrentPositionAsTuple()
	if(isnull(src.pawn))
...
/datum/goai/sim_commander/proc/FindPathTo(var/trg, var/min_dist = 0, var/avoid = null, var/proc/adjproc = null, var/proc/distanceproc = null, var/list/adjargs = null)
	if(isnull(src.pawn))
		world.log << "No owned mob found for [src.name] AI"
...
/datum/goai/sim_commander/proc/ValidateWaypoint(var/PriorityQueue/queue, var/trust_first = null)
...
/datum/goai/sim_commander/proc/GetCurrentChunk()
	var/datum/chunkserver/chunkserver = GetOrSetChunkserver()
	var/datum/chunk/startchunk = chunkserver.ChunkForAtom(src)
	return startchunk


/datum/goai/sim_commander/proc/BuildPathTrackerTo(var/trg, var/min_dist = 0, var/avoid = null, var/inh_frustration = 0, var/proc/costproc = null)
...
/datum/goai/sim_commander/proc/StartNavigateTo(var/trg, var/min_dist = 0, var/avoid = null, var/inh_frustration = 0, var/refresh_loc_memories = TRUE, var/proc/costproc = null)
	src.is_repathing = 1
...
/datum/goai/sim_commander/proc/CancelNavigate()
	src.active_path = null
	src.is_repathing = 0
	return TRUE


/datum/goai/sim_commander/proc/MovementSystem()
...
/datum/goai/sim_commander/proc/randMove()
	if(src.is_moving)
		return FALSE
