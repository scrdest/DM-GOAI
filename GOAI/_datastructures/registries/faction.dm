...
/proc/deregister_faction(var/id)
	...
	var/datum/goai/ai = GOAI_LIBBED_GLOB_PREFIX(?.)global_faction_registry[id]
	...
	*/
	...
	GOAI_LIBBED_GLOB_PREFIX(?.)global_faction_registry[id] = null
...
/datum/goai/proc/RegisterFaction()
	...
	if(src.registry_index)
		...
		GOAI_LIBBED_GLOB_PREFIX(?.)global_faction_registry?[src.registry_index] = src
		return GOAI_LIBBED_GLOB_PREFIX(?.)global_faction_registry

	GOAI_LIBBED_GLOB_PREFIX(?.)global_faction_registry += src
