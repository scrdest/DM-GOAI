...
/datum/utility_ai/abstract_commander
...
/datum/utility_ai/abstract_commander/Life()
	. = ..()
...
/datum/utility_ai/abstract_commander/LifeTick()
	if(paused)
		return
...
/datum/utility_ai/abstract_commander/InitRelations()
