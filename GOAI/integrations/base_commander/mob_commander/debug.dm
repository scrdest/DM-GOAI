...
/mob/verb/InspectGoaiMobCommanderVars(datum/goai/mob_commander/commander in GOAI_LIBBED_GLOB_PREFIX(.)global_goai_registry)
...
/mob/verb/InspectGoaiMobCommanderTrackerVars(datum/goai/mob_commander/commander in GOAI_LIBBED_GLOB_PREFIX(.)global_goai_registry)
	set category = "Debug GOAI Commanders"
...
/mob/verb/CleanupDetachedCommanders()
	...
	for(var/datum/goai/mob_commander/commander in GOAI_LIBBED_GLOB_PREFIX(.)global_goai_registry)
