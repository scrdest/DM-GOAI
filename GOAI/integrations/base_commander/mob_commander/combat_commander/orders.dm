...
/mob/verb/CommanderGiveFollowOrder(datum/goai/mob_commander/combat_commander/M in GOAI_LIBBED_GLOB_PREFIX(.)global_goai_registry, mob/Trg in world)
...
/mob/verb/CommanderGiveMoveOrder(datum/goai/mob_commander/combat_commander/M in GOAI_LIBBED_GLOB_PREFIX(.)global_goai_registry, posX as num, posY as num)
	set category = "Commander Orders"
...
/mob/verb/CommanderCancelOrders(datum/goai/mob_commander/combat_commander/M in GOAI_LIBBED_GLOB_PREFIX(.)global_goai_registry)
	set category = "Commander Orders"
...
/mob/verb/CommanderDisarm(datum/goai/mob_commander/combat_commander/M in GOAI_LIBBED_GLOB_PREFIX(.)global_goai_registry)
	set category = "Commander Orders"
...
/mob/verb/CommanderPanic(datum/goai/mob_commander/combat_commander/M in GOAI_LIBBED_GLOB_PREFIX(.)global_goai_registry)
	set category = "Commander Orders"
...
/mob/verb/CommanderSetForcedFriendTag(datum/goai/mob_commander/combat_commander/M in GOAI_LIBBED_GLOB_PREFIX(.)global_goai_registry, tag as text)
	set category = "Commander Orders"
...
/mob/verb/CommanderSetForcedFoeTag(datum/goai/mob_commander/combat_commander/M in GOAI_LIBBED_GLOB_PREFIX(.)global_goai_registry, tag as text)
	set category = "Commander Orders"
...
/mob/verb/CommanderDropRelationshipTag(datum/goai/mob_commander/combat_commander/M in GOAI_LIBBED_GLOB_PREFIX(.)global_goai_registry, tag as text)
	set category = "Commander Orders"
...
/mob/verb/CommanderMakeBerserk(datum/goai/mob_commander/combat_commander/M in GOAI_LIBBED_GLOB_PREFIX(.)global_goai_registry)
	set category = "Commander Orders"
