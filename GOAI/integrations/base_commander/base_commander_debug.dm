...
/mob/verb/RebootGoaiCommandersAll()
	...
	for(var/datum/goai/commander in GOAI_LIBBED_GLOB_PREFIX(?.)global_goai_registry)
...
/mob/verb/RebootGoaiCommander(datum/goai/mob_commander/combat_commander/commander in GOAI_LIBBED_GLOB_PREFIX(?.)global_goai_registry)
	set category = "Debug GOAI Commanders"
...
/mob/verb/DeleteGoaiCommander(datum/goai/mob_commander/combat_commander/commander in GOAI_LIBBED_GLOB_PREFIX(?.)global_goai_registry)
	set category = "Debug GOAI Commanders"
...
/mob/verb/PauseGoaiCommander(datum/goai/mob_commander/combat_commander/commander in GOAI_LIBBED_GLOB_PREFIX(?.)global_goai_registry)
	set category = "Debug GOAI Commanders"
	commander.life = 0
	return
...
/mob/verb/UnpauseGoaiCommander(datum/goai/mob_commander/combat_commander/commander in GOAI_LIBBED_GLOB_PREFIX(?.)global_goai_registry)
	set category = "Debug GOAI Commanders"
