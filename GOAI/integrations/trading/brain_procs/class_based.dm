...
// /datum/brain/utility's attributes best_purchase_for_need_proc & best_sale_for_need_proc
//
...
// - caller - a reference to the calling brain (not used here either)
//
...
best_purchase_for_need_proc = /proc/utility_best_trade_item_selector_kwargs
best_purchase_for_need_proc_args = list("best_commodity_for_need" = list(...your choices...))
best_sale_for_need_proc = /proc/utility_best_trade_item_selector_kwargs
...
/proc/utility_best_trade_item_selector_kwargs(var/need_key, var/list/kwargs, var/datum/brain/caller)
