...
#define GOAI_CONTRACT_LIFECYCLE_FULFILLED 0

// AWAITING_SIGNOFF_CREATOR => the creator of the contract has not confirmed it's all good yet
#define GOAI_CONTRACT_LIFECYCLE_AWAITING_SIGNOFF_CREATOR 1

// AWAITING_SIGNOFF_CONTRACTOR => the receiver of the contract has not confirmed it's all good yet
#define GOAI_CONTRACT_LIFECYCLE_AWAITING_SIGNOFF_CONTRACTOR 2

// GOODS_PENDING => Payer did not receive ALL the goods yet.
#define GOAI_CONTRACT_LIFECYCLE_GOODS_PENDING 4

// PAYMENT_PENDING => Money not yet transferred to Supplier
#define GOAI_CONTRACT_LIFECYCLE_PAYMENT_PENDING 8
...
#define GOAI_CONTRACT_LIFECYCLE_INITIAL 15
...
#define GOAI_CONTRACT_IS_DIRTY_COMPLETED(ContractStateVal) (!(ContractStateVal & (GOAI_CONTRACT_LIFECYCLE_AWAITING_SIGNOFF_CREATOR + GOAI_CONTRACT_LIFECYCLE_AWAITING_SIGNOFF_CONTRACTOR)))
...
#define GOAI_CONTRACT_IS_PROGRESSED(ContractStateVal) (ContractStateVal > GOAI_CONTRACT_LIFECYCLE_INITIAL)
